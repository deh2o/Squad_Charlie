...
The authenticated control center now includes a dedicated **Production** workspace
with a BI-style oilfield performance dashboard: date/well/status filters, KPI cards,
daily production ranking, weekly production trend, downtime distribution,
performance-to-target gauge, production by well, and a well performance matrix.
The existing predictive-maintenance workspaces remain available through the sidebar.

Select a well, press **Run Diagnostics** to score it, switch charts from the
well-monitoring toolbar, and read the technical / stakeholder reports in the
Reports workspace.
